 ...
 * @author Bolivar
 */
public class EconomicoFactoryTest {
    
    public EconomicoFactoryTest() {
    }
    ...
    /**
     * Test of crearVehiculo method, of class EconomicoFactory.
     */
    @Test
    public void testCrearVehiculo() {
        System.out.println("crearVehiculo");
        EconomicoFactory instance = new EconomicoFactory();
