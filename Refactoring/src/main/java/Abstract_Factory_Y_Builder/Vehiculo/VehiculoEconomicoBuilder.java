...
class VehiculoEconomicoBuilder implements VehiculoBuilder {
    private VehiculoEconomico vehiculo;

    public VehiculoEconomicoBuilder() {
        this.vehiculo = new VehiculoEconomico();
    }
